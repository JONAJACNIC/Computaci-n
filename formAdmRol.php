...
$SQL="SELECT login.pk_log_id, login.log_usuario , login.log_clave , rol.rol_dsc, login.fk_rol_id , login.fk_sc_id, rol.rol_dsc
FROM login
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a class="btn btn-danger" href="eliminar_admrol.php?id=<?php echo $fila['pk_log_id']?>">

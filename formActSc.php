                    ...
                    <div class="card-body">
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-4 d-flex align-items-center">
                                ...
                                <input type="text" class="form-control" name="direccion" id="direccion" value="<?php echo isset($datosFormulario['direccion']) ? htmlspecialchars($datosFormulario['direccion']) : ''; ?>" oninput="convertirMayusculas('direccion')" required readonly>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-3 d-flex align-items-center">
                                ...
                                <input type="text" class="form-control" name="celular" id="celular" value="<?php echo isset($datosFormulario['celular']) ? htmlspecialchars($datosFormulario['celular']) : ''; ?>" maxlength="10" onkeypress="return soloNumeros(event)" required readonly>
                            ...
                            <div class="col-md-3 d-flex align-items-center">
                                ...
                                <input type="input" class="form-control" name="telefono" id="telefono" value="<?php echo isset($datosFormulario['telefono']) ? htmlspecialchars($datosFormulario['telefono']) : ''; ?>" readonly>
                            ...
                            <div class="col-md-3 d-flex align-items-center">
                                ...
                                <input type="text" class="form-control" name="correo" id="correo" value="<?php echo isset($datosFormulario['correo']) ? htmlspecialchars($datosFormulario['correo']) : ''; ?>" required readonly>

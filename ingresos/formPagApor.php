          ...
          <div class="card-body">
            ...
            if ($cta_sc_id > 0) {
              ...
              if ($result_aportaciones->num_rows > 0) {
                ...
                echo '<label for="adiCert" class="form-label">Certificados</label>';
                ...
                echo '<label for="adiFond" class="form-label" style="white-space: nowrap;">Fondo Estratégico</label>';
                ...
                echo '<label class="form-label">Montos multiplos de $20         </label>';
                echo '<label class="form-label">Montos multiplos de $1</label>';
                echo '</div>';
              } else {

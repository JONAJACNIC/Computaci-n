...
<body>
    <div class="container-fluid">
        <h5 class="text-center ">Fondo Estratégico</h5>
        <form action="" method="post">
            ...
            <div class="card mt-2">
                <div class="card-header fw-bold">
                    Gastos Fondo Estratégico
                </div>
                <div class="card-body ">
                    <!-- Fila 1 -->
                    <div class="row mb-2 justify-content-center">
                        <!-- Campo fecha de fondos estrategicos-->
                        ...
                        <!-- Cantidad del gasto estrategicos -->
                        <div class="col-md-4 d-flex ">
                            <label for="cantPres" class="form-label me-3">Monto Deseado</label>
                            <input type="text" class="form-control w-50" name="cantGas" id="cantGas">
                    ...
                    <div class="row mb-2 justify-content-center">
                        ...
                        <div class="col-md-4 d-flex mb-2 ">
                            ...
                            <select name="tipGas" id="tipGas" class="form-select w-50" required>
                                ...
                                $sql = "SELECT pk_tp_egre_id, tp_egre_dsc FROM tipo_egreso where pk_tp_egre_id IN (14, 15, 16, 17);";
                                $result = $conn->query($sql);
                                // Generar las opciones dinámicamente
                                while ($row = $result->fetch_assoc()) {
                        ...
                        </div><!-- fin campo tipo fondos estrategicos-->
                    </div><!-- Fin Fila 2 -->
                </div>

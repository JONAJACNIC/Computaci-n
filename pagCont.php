          ...
          <li class="d-flex align-items-center bg-primary m-2 border-bottom border-white border-1">
            ...
            <div class="dropdown">
              ...
              <div class="dropdown-menu">
                <a class="dropdown-item" href="#" >Respotes</a>
          ...
          <img src="iconos/male-icon.svg" alt="Icono de Socio" class="w-25 h-25" />
                    ...
                    <img src="iconos/hand-holding-dollar-solid.svg" alt="Icono de Ingresos" class=" w-25" />
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                          <a class="dropdown-item" href="#">Gastos Administrativos </a>
                          <a class="dropdown-item" href="#">Fondo Estrategico </a>
                          <a class="dropdown-item" href="#">Fondo General </a>
                          <a class="dropdown-item" href="#">Fondo Desgravamen </a>
                          <a class="dropdown-item" href="#">Aportes Capitales  </a>
                        </div>
                      </div>
                    </li>

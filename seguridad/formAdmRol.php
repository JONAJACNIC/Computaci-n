...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (mysqli_num_rows($result_verificar_usuario) > 0) {
    ...
    $queryregistrar = "INSERT INTO login(log_usuario, log_clave, fk_rol_id,fk_est_id) VALUES ('$nombre', '$pass_fuerte', '$rol','1')";
...
$SQL = "SELECT login.pk_log_id, login.log_usuario , login.log_clave , rol.rol_dsc, login.fk_rol_id , login.fk_sc_id, rol.rol_dsc, login.fk_est_id
FROM login
...
<head>
  ...
  <style>
    .table-container {
      max-height: 500px;
      /* Establece la altura máxima que deseas */
      overflow-y: auto;
